...
urlpatterns = patterns('juque.library.views',
    ...
    url(r'^playlist/(?P<playlist_id>\d+)/$', 'playlist', name='library-playlist'),
    ...
    url(r'^track/multi-edit/$', 'track_multi_edit', name='track-multi-edit'),
    ...
    url(r'^ajax/autocomplete/$', 'ajax_autocomplete', name='ajax-autocomplete'),
)
